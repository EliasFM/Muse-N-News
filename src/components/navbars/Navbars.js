  ...
  render() {
    ...
    return (
      <Navbar className='navbar-expand-md navbar-dark fixed-top bg-dark'>
        ...
        <NavForm searchCallback={this.props.searchCallback} isLoading={this.props.isLoading} currentTab={currentTab} currentUser={this.props.currentUser} handleSignOut={this.props.handleSignOut} isMain={this.props.isMain}/>
        </Collapse>
      </Navbar>
    )
  }
